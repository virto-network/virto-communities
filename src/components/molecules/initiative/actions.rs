                                                        ...
                                                        li {
                                                            ComboInput {
                                                                ...
                                                                on_change: move |event: ComboInputValue| {
                                                                    ...
                                                                    if let ActionItem::RemoveMembers(ref mut meta) = initiative.get_action(index) {
                                                                        meta.members[index_meta] = MemberItem { medium, account: event.input };
                                                                        initiative.update_action(index, ActionItem::RemoveMembers(meta.clone()));
                                                                    }
                                                                }
                                                            }
                                                            IconButton {
